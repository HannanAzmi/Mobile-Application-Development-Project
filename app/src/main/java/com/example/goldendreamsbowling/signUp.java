                                ...
                                databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                                    ...
                                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                                        ...
                                        if (snapshot.hasChild(UserID)) {
                                            ...
                                            databaseReference.child("membership").child(UserID).child("Email").setValue(Email);
                                            databaseReference.child("membership").child(UserID).child("FullName").setValue(Name);
                                            databaseReference.child("membership").child(UserID).child("Status").setValue("Inactive");
